...
export const createCheckoutSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `https://e-tuition-f8526.web.app/dashboard/payment-success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `https://e-tuition-f8526.web.app/dashboard/payment-cancelled`,
    });
